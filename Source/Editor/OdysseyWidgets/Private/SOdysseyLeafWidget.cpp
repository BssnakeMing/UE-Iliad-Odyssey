...
{
    surface = MakeUnique< FOdysseySurfaceTexture2DEditable >( FMath::Max( 1.f, InternalSize.X ), FMath::Max( 1.f, InternalSize.Y ) );
...
SOdysseyLeafWidget::PaintInternalBuffer( int iReason ) const
{
    ...
    ctx.Fill(*surface->Block(), ::ULIS::FColor::FromRGBA8( 220, 220, 220 ));
    ctx.Finish();
